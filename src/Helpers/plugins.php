...
if (!function_exists('bs_hash_file')) {
    ...
    function bs_hash_file(Illuminate\Http\UploadedFile $file)
    {
        ...
        $responses = event(new System\Events\HashingFile($file));
...
if (!function_exists('bs_footer_extra')) {
    ...
    function bs_footer_extra()
    {
        ...
        Event::fire(new System\Events\RenderingFooter($extraContents));
...
if (!function_exists('bs_header_extra')) {
    ...
    function bs_header_extra()
    {
        ...
        Event::fire(new System\Events\RenderingHeader($extraContents));
...
if (!function_exists('bs_menu')) {
    ...
    function bs_menu($type)
    {
        ...
        Event::fire($type == "user" ? new System\Events\ConfigureUserMenu($menu)
            : new System\Events\ConfigureAdminMenu($menu));
...
if (!function_exists('runtime_check')) {
    ...
    function runtime_check(array $requirements)
    {
        ...
        foreach (array_get($requirements, 'write_permission', []) as $dir => $power) {
            $realPath = realpath(base_path($dir));
