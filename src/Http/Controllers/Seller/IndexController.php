...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        $stats = [
            'order_count' => $this->order->createCount($this->shop_id),
            'product_count' => $this->product->createCount($this->shop_id),
        ];
        ...
        return view('seller::index.index', compact('stats', 'orders', 'orders_chart', 'pages'));
    }
}
