...
class DataBasesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend::systems.databases.index', compact('items', 'pages'));
    }
    ...
    public function store(Request $request)
    {
        ...
        settings(['database' => $items]);
        return redirect()->route('backend.systems.databases.index')->with('message', trans('backend.messages.update_success'));
    }
