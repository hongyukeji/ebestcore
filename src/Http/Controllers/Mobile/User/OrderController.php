...
class OrderController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('mobile::users.orders.index', compact('orders', 'orders_unpaid', 'orders_wait_delivery', 'orders_wait_received', 'orders_finish', 'orders_wait_comment'));
    }

    public function show(Order $order)
    {
        $order or abort(404);
        return view('mobile::users.orders.show', compact('order'));
    }
