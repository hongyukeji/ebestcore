...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        $this->middleware('guest.user:web,frontend')->except('logout');
    }
    ...
    {
        return request('return_url') ?: route('frontend.index');
    }
    ...
    public function logout(Request $request)
    {
        ...
        //return redirect(request('return_url') ?: route('frontend.index'));
        return redirect()->back() ?: redirect()->route('frontend.index');
    }
    ...
    {
        return view('frontend::auth.verify_code');
    }
